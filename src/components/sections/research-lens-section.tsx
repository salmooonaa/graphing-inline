...
export function ResearchLensSection({ content }: ResearchLensSectionProps) {
  return (
    <section id="lens" className="border-b border-[var(--line)] py-18 sm:py-20">
      <Container>
        <div className="grid gap-12 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,1.3fr)] lg:items-start">
          <div className="section-reveal space-y-8 lg:pr-10">
          ...
          <div className="section-reveal reveal-delay-1 space-y-6">
            <ImagePlaceholder
            ...
            <dl className="grid gap-px overflow-hidden border border-[var(--line)] bg-[var(--line)] md:grid-cols-3">
