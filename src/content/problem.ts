  ...
  demo: {
    segments: [
      ...
      { type: "run", text: " cities and counties are hiking their minimum wages: Flagstaff, Arizona, to " },
      {
        ...
        id: "tok1",
        text: "$17.40",
        graphic: { kind: "bar", value: 17.40, max: 18.85, min: 14 },
      },
      { type: "run", text: "; Mountain View, California, to " },
      {
        ...
        id: "tok2",
        text: "$18.85",
        graphic: { kind: "bar", value: 18.85, max: 18.85, min: 14 },
      },
      { type: "run", text: "; Denver, Colorado, to " },
      {
        ...
        id: "tok3",
        text: "$18.29",
        graphic: { kind: "bar", value: 18.29, max: 18.85, min: 14 },
      },
      { type: "run", text: "; and Portland, Maine, to " },
      {
        ...
        id: "tok4",
        text: "$15",
        graphic: { kind: "bar", value: 15, max: 18.85, min: 14 },
      },
      { type: "run", text: "." },
    ],
  },
